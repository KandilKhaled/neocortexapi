    ...
    public partial class HTMSerializationTests
    {
        ...
        public void SerializationCellArrayTest()
        {
            ...
            using (StreamWriter sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(cells, null, sw);
            }

            using (StreamReader sr = new StreamReader(fileName))
            {
                var c = HtmSerializer.Deserialize<Cell[]>(sr, new HtmSerializationFormatter());
        ...
        public void Test1()
        {
            ...
            {
                HtmSerializer serializer = new HtmSerializer(new HtmSerializationFormatter());
                serializer.Serialize(new List<string> { "bla" }, null, sw);
            }
        ...
        public void SerializationDictionaryStringCellTest()
        {
            ...
            {
                HtmSerializer serializer = new HtmSerializer(new HtmSerializationFormatter());
                serializer.Serialize(dict, null, sw);
            }
            using (StreamReader sr = new StreamReader(fileName))
            {
                var dict1 = HtmSerializer.Deserialize<Dictionary<string, Cell>>(sr, new HtmSerializationFormatter());
        ...
        public void Test3_1()
        {
            ...
            using (StreamReader sr = new StreamReader(fileName))
            {
                var d = HtmSerializer.Deserialize<DistalDendrite[]>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationAbitraryTypeTest()
        {
            ...
            using (StreamReader sr = new StreamReader(fileName))
            {
                var d = HtmSerializer.Deserialize<Dictionary<string, Bla>>(sr, new HtmSerializationFormatter());
            }
        }
        ...
        public void SerializationIntegerArrayTest()
        {
            ...
            {
                HtmSerializer serializer = new HtmSerializer(new HtmSerializationFormatter());
                serializer.Serialize(array, null, sw);
            }
            ...
            var res = HtmSerializer.Deserialize<int[]>(reader, new HtmSerializationFormatter());
        ...
        public void SerializationIntegerListTest()
        {
            ...
            var res = HtmSerializer.Deserialize<List<int>>(reader, new HtmSerializationFormatter());
        ...
        public void SerializationHtmConfigTest()
        {
            ...
            using (var sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(htmConfig_L2, null, sw);
            }
            using (var sr = new StreamReader(fileName))
            {
                var htmConfig = HtmSerializer.Deserialize<HtmConfig>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationConnectionsTest()
        {
            ...
            using (var sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(mem, null, sw);
            }
            using (var sr = new StreamReader(fileName))
            {
                var connection = HtmSerializer.Deserialize<Connections>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationHomeostaticPlasticityControllerTest()
        {
            ...
            using (var sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(hpa_sp_L2, null, sw);
            }
            using (var sr = new StreamReader(fileName))
            {
                var hpa = HtmSerializer.Deserialize<HomeostaticPlasticityController>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationSparseObjectMatrixInSpatialPoolerMTInitializedByConnectionsTest()
        {
            ...
            using (var sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(mem.Memory, null, sw);
            }
            using (var sr = new StreamReader(fileName))
            {
                var memory = HtmSerializer.Deserialize<SparseObjectMatrix<Column>>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationHtmConfigSpatialPoolerMTInitializedByConnectionsTest()
        {
            ...
            using (var sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(mem.HtmConfig, null, sw);
            }
            using (var sr = new StreamReader(fileName))
            {
                var htmConfig1 = HtmSerializer.Deserialize<HtmConfig>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationConnectionsSpatialPoolerMTInitializedByConnectionsTest()
        {
            ...
            using (var sr = new StreamReader(fileName))
            {
                var connections = HtmSerializer.Deserialize<Connections>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationSpatialPoolerInitialzedByConnectionsTest()
        {
            ...
            using (var sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(sp, null, sw);
            }
            using (var sr = new StreamReader(fileName))
            {
                var sp1 = HtmSerializer.Deserialize<SpatialPooler>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationSpatialPoolerMTInitialzedByConnectionsTest()
        {
            ...
            using (var sr = new StreamReader(fileName))
            {
                var sp1 = HtmSerializer.Deserialize<SpatialPoolerMT>(sr, new HtmSerializationFormatter());
                Assert.IsTrue(sp.Equals(sp1));
            }
        }
        ...
        public void SerializationTemporalMemoryInitializedByConnectionsTest()
        {
            ...
            using (var sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(tm, null, sw);
            }
            using (var sr = new StreamReader(fileName))
            {
                var tm1 = HtmSerializer.Deserialize<TemporalMemory>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationScalarEncoderTest()
        {
            ...
            using (var sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(encoder, null, sw);
            }
            using (var sr = new StreamReader(fileName))
            {
            ...
            using (var sr = new StreamReader(fileName))
            {
                var scalarEncoder = HtmSerializer.Deserialize<ScalarEncoder>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationCortexLayerTest()
        {
            ...
            using (var swrt = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(layer1, null, swrt);
            }
            using (var sr = new StreamReader(fileName))
            {
                var cortexLayer = HtmSerializer.Deserialize<CortexLayer<object, object>>(sr, new HtmSerializationFormatter());
        ...
        public void SerializationKeyValuePairTest()
        {
            ...
            using (StreamWriter sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(kv, null, sw);
            }

            using (StreamReader sr = new StreamReader(fileName))
            {
                var kv1 = HtmSerializer.Deserialize<KeyValuePair<int, Animal>>(sr, new HtmSerializationFormatter());
            }
        }
        ...
        public void SerializationAbstractClassTest()
        {
            ...
            using (StreamWriter sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize((Animal)a, "bla", sw, typeof(Animal));
            }
            using (StreamReader sr = new StreamReader(fileName))
            {
                var kv1 = HtmSerializer.Deserialize<Cat>(sr, new HtmSerializationFormatter());
            }
        }
        ...
        public void SerializationMultiDimArrayTest()
        {
            ...
            using (StreamWriter sw = new StreamWriter(fileName))
            {
                ...
                serializer.Serialize(cats, null, sw);
            }

            using (StreamReader sr = new StreamReader(fileName))
            {
                var cats1 = HtmSerializer.Deserialize<Animal[,]>(sr, new HtmSerializationFormatter());
            }
        }
        ...
        public void SerializationPolymorphismListTest()
        {
            ...
            using (StreamReader sr = new StreamReader(fileName))
            {
                var cats1 = HtmSerializer.Deserialize<List<Animal>>(sr, new HtmSerializationFormatter());
            }
        }
        ...
        public void IterateMultiDimArrayTest()
        {
            ...
            var listIndexes = serializer.IterateMultiDimArray(array);
        }
        ...
        public void RandomTest()
        {
            ...
            using (StreamWriter sw = new StreamWriter(fileName))
            {
                serializer.Serialize(r, null, sw);
            }
            using (StreamReader sr = new StreamReader(fileName))
            {
                var r1 = HtmSerializer.Deserialize<Random>(sr, new HtmSerializationFormatter());
            }
        }
        ...
        public void SerializeConnectionsWithActiveSegmentTest()
        {
            ...
            {
                HtmSerializer serializer = new HtmSerializer(new HtmSerializationFormatter());
                serializer.Serialize(connections, null, sw);
            }
        ...
        public void SerializationCortexLayerSpatialPoolerCompareOutputTest()
        {
            ...
            {
                HtmSerializer serializer = new HtmSerializer(new HtmSerializationFormatter());
                serializer.Serialize(cortexLayer, null, swrt);
            }
