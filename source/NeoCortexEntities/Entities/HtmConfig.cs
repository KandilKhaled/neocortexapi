...
namespace NeoCortexApi.Entities
{
    ...
    public class HtmConfig : ISerializable
    {
        ...
        public void Serialize(StreamWriter writer)
        {
            ...
            ser.SerializeValue<double>(this.PotentialPct, writer);
            ser.SerializeValue<double>(this.StimulusThreshold, writer);
            ser.SerializeValue<double>(this.SynPermBelowStimulusInc, writer);
            ...
            ser.SerializeValue<double>(this.SynPermMin, writer);
            ser.SerializeValue<double>(this.InitialSynapseConnsPct, writer);
            ser.SerializeValue<double>(this.NumActiveColumnsPerInhArea, writer);
            writer.WriteLine();
            ser.SerializeValue<double>(this.MinPctOverlapDutyCycles, writer);
            ser.SerializeValue<double>(this.MinPctActiveDutyCycles, writer);
            ser.SerializeValue<double>(this.PredictedSegmentDecrement, writer);
            ...
            ser.SerializeValue<double>(this.PermanenceIncrement, writer);
            ser.SerializeValue<double>(this.PermanenceDecrement, writer);
        ...
        public void Serialize(object obj, string name, StreamWriter sw)
        {
            ...
            serializer.SerializeObject(obj, name, sw, excludeMembers);
        }
